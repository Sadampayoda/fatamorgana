...
$query = $conn->query("SELECT * FROM photos WHERE type = 'menu'");
session_start();
$data = [];
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="../controller/foto.php" method="post">
                                                        ...
                                                        <input type="hidden" id="link" name="link" value="foto-menu/index.php" >
                ...
                <form method="POST" action="../controller/foto.php" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="type" name="type" value="menu" >
                            <input type="hidden" id="link" name="link" value="foto-menu/index.php" >
                        </div>
                    </div>
                    <div class="modal-footer">
