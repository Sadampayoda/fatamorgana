...
<head>
  ...
  <title>Fatamorgana Coffe - Barang</title>
                    ...
                    <?php if ($result->num_rows > 0) : ?>
                      <?php while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateDataModal<?php echo $row['inventory_id']; ?>">Update</button>
                        ...
                        <!-- Update Modal -->
                        <div class="modal fade" id="updateDataModal<?php echo $row['inventory_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-body">
                                <form method="post">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_keluar" value="<?php echo $row['tanggal_keluar']; ?>">
                                  </div>
                                  <div class="form-group">
                                    <label>Entry by</label>
                                    <input type="text" class="form-control" name="entry_by" value="<?php echo $row['entry_by']; ?>">
                                  </div>
                                  <div class="form-group">
                                    <label>Exit by</label>
                                    <input type="text" class="form-control" name="exit_by" value="<?php echo $row['exit_by']; ?>">
                                  </div>
                                  <div class="form-group">
                                    <label>Total harga barang keluar</label>
                                    <input type="number" class="form-control" name="total_cost" value="<?php echo $row['total_cost']; ?>">
                                  </div>
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="tipe">
                      <option value="<?php echo 'Espresso' ?>">Espresso</option>
                      <option value="<?php echo 'Non-Coffe' ?>">Non-Coffe</option>
                      <option value="<?php echo 'Manual Brew' ?>">Manual Brew</option>
                      <option value="<?php echo 'Tea Series' ?>">Tea Series</option>
                      <option value="<?php echo 'Kudapan' ?>">Kudapan</option>
                      <option value="<?php echo 'Lainnya' ?>">Lainnya</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label>Kuantitas</label>
                  ...
                  <div class="form-group">
                    <label>Entry by</label>
                    <input type="text" class="form-control" name="entry_by" required>
                  </div>
                  <div class="form-group">
                    <label>Exit by</label>
                    <input type="text" class="form-control" name="exit_by" required>
                  </div>
                  <div class="form-group">
                    <label>Total harga barang keluar</label>
